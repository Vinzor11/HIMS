                            ...
                            <>
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        value={data.product_code ?? product.product_code}
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        value={data.product_name ?? product.product_name}
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <input
                                        type="hidden"
                                        name="category_id"
                                        value={data.category_id ?? product.category_id}
                                    />
                                    <Select
                                        value={(data.category_id ?? product.category_id)?.toString()}
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="grid gap-2">
                                        ...
                                        <Input
                                            ...
                                            value={data.cost_price ?? product.cost_price}
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Input
                                            ...
                                            value={data.selling_price ?? product.selling_price}
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        value={data.stock_qty ?? product.stock_qty}
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <input
                                        type="hidden"
                                        name="status"
                                        value={data.status ?? product.status}
                                    />
                                    <Select
                                        value={data.status ?? product.status}
